...
class CronogramaController extends AbstractCrudController
{
    ...
    public function indexPaginationAction()
    {
        ...
        $camposFilter = [
            '0' => NULL,
            '1' => [
                'filter' => "cronograma.nm_acao LIKE ?",
            ],
            '2' => NULL,
        ];


        $paginator = $this->service->getCronogramaPaginator($filter, $camposFilter);
    ...
    public function gravarAction(){
        ...
        $this->redirect()->toRoute('navegacao', array('controller' => 'cronograma-cronograma', 'action' => 'index'));
