...
class PlanejamentoController extends AbstractCrudController
{
    ...
    public function indexPaginationAction()
    {
        ...
        $camposFilter = [
            '0' => NULL,
            '1' => [
                'filter' => "planejamento.nm_problema LIKE ?",
            ],
            '2' => NULL,
        ];


        $paginator = $this->service->getPlanejamentoPaginator($filter, $camposFilter);
    ...
    public function gravarAction(){
        ...
        $this->redirect()->toRoute('navegacao', array('controller' => 'planejamento-planejamento', 'action' => 'index'));
